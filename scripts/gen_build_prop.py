...
def parse_args():
  ...
  config["DroidXDesc"] = config["BuildDesc"]
  config["DroidXDevice"] = config["DeviceName"]
...
def generate_build_info(args):
  ...
  if config["BuildVariant"] == "user":
    ...
    print(f"ro.build.display.id?={config['DroidXDesc']}")
  ...
  print(f"ro.droidx.device={config['DroidXDevice']}")
